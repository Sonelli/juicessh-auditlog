package com.sonelli.juicessh.auditlog.activities;
...
import com.sonelli.juicessh.auditlog.fragments.AuditLogFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, new AuditLogFragment())
                    .commit();
        }
